...
enum AuthSignatures {
	Signature_NativeRegistrationTable,
	Signature_OwnedExplosionBypass,
	Signature_TriggerScriptEvent,
	Signature_SyncLobbyWeather,
	Signature_SyncLobbyWeatherPatch,
	Signature_SyncLobbyTimePatch,
	Signature_SyncLobbyTime,
	Signature_SendIncrementStatEvent,
	Signature_JoinSelectedPlayer,
	Signature_RegisterYTD,
	Signature_GetTPCamera, //new
	Signature_GetGameCameraManager, //new
	Signature_ThirdPersonCameraPointer, //new
	Signature_GetNetGamePlayerFromMessageHandler,
	Signature_ProcessLeaveJoin,
	Signature_InterceptIncomingChatMessage,
	Signature_GetGXTText,
	Signature_LegalBypass,
	Signature_GameState,
	Signature_GlobalPointer,
	Signature_WorldPointer,
	Signature_ModelCheck,
	Signature_ModelPatch,
	Signature_IsInSpectator,
	Signature_NetworkPlayerManager,
	Signature_ScriptTable,
	Signature_QuadManager,
	Signature_StatGetInt,
	Signature_IsDlcPresent,
	Signature_SyncSceneStuff,
	Signature_WaterTune,
	Signature_MapEditorPool,
	Signature_MapEditorVTable,
	Signature_HandleNetworkEvent,
	Signature_SpawnNetObj,
	Signature_SessionInfomation,
	Signature_PlayerListConstructor,
	Signature_RIDManager,
	ReceiveCloneSync,
	Signature_GetEntityHandle,
	Signature_GetEntityAddress,
	Signature_ObjectPool,
	Signature_PedPool,
	Signature_VehiclePool,
	Signature_EntityPool,
	Signature_ReceiveNetObject,
	Signature_CRCCriticalSection,
	Signature_AppendTransaction,
	Signature_MetricCheat,
	Signature_AddEventToQueuePtr,
	Signature_AddEventToQueue,
	Signature_MetricFunc,
	Signature_KickCheck,
	Signature_RestoreNtPointers,
	Signature_ProcessMetric,
	Signature_HandleMetric1,
	Signature_HandleMetric2,
	Signature_HandleMetric3,
	Signature_SomethingIDK,
	Signature_IntegrityCheck,
	Signature_SomethingIDK2,
	Signature_Telemetry,
	Signature_IntegrityCheck2,
	Signature_ReportCash,
	Signature_SendCashSpawnMetric,
	Signature_EarnFailed,
	Signature_IncrementStatEvent,
	Signature_HandleNetworkEvents,
	/*Signature_RemoveAllWeaponsEvent,
	Signature_RemoveWeaponEvent,
	Signature_GiveWeaponEvent,
	Signature_WeatherChangeEvent,
	Signature_RequestControlEvent,
	Signature_WantedLevelEvent,
	Signature_ClearPedTaskEvent,
	Signature_ExplosionEvent,
	Signature_FireEvent,
	Signature_PTFXEvent,
	Signature_PlaySoundEvent,
	Signature_ScriptEvent,
	Signature_VoteKickEvent, */
	Signature_PopulateVehicleHash
};
...
typedef struct SimpleVector3 {
	float x, y, z;
};

typedef struct SimpleVector2 {
	float x, y;
};
...
struct Texture {
	...
	Texture(const char* a, const char* b) {
		dict = a;
		id = b;
	}

	bool IsEmpty() {
		if (dict.empty() || id.empty())
			return false;
		return true;
	}
};
